...
export const register = async (req, res) => {
    try {
        ...
        console.log("4. Cloudinary upload finished successfully.");

        console.log("5. Checking if user exists in DB...");
        const user = await User.findOne({ email });
        console.log("6. DB check finished.");
        ...
        console.log("9. Password hashing finished.");

        console.log("10. Creating user in DB...");
        await User.create({
            fullname,
            email,
            phoneNumber,
        ...
        console.log("11. User created in DB successfully.");
